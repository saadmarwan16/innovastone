...
const QuickStats: FunctionComponent<QuickStatsProps> = () => {
    return ( <section className="relative sm:-mt-32 z-10">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="relative p-5 sm:p-8 md:p-12 bg-transparent sm:bg-stone-charcoal/95 sm:backdrop-blur-lg rounded-2xl sm:border sm:border-white/10 sm:shadow-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 hidden sm:block" style={{ 
              backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0L45 15H15L30 0zm0 60L15 45h30L30 60zm15-15L60 30V0L45 15v30zM0 30l15 15V15L0 30zm0-30v30L15 15V0H0zm45 0v15L60 0H45zM0 60h15L0 45v15zm45 0v-15l15 15H45z' fill='%23C9A26B' fill-opacity='0.05'/%3E%3C/svg%3E\")",
              ...
              {[
                {
                  ...
                  icon: <Clock className="h-6 w-6 sm:h-8 sm:w-8 text-stone-gold" />
                },
                {
                  number: "50+",
                  label: "Projects Completed",
                  icon: <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-stone-gold" />
                },
                {
                  number: "15+",
                  label: "Countries Served",
                  icon: <Globe className="h-6 w-6 sm:h-8 sm:w-8 text-stone-gold" />
                }
              ].map((stat, index) => (
                <div 
                  key={index} 
                ...
                >
                  ...
                  <div>
                    <p className="text-xl sm:text-2xl md:text-4xl font-bold text-stone-marble mb-0.5 sm:mb-1 tracking-tight">{stat.number}</p>
                    <p className="text-xs sm:text-sm md:text-base text-stone-marble/70 font-light tracking-wide">{stat.label}</p>
                  </div>
                </div>
              ))}
            </div>
